  ...
  <div>
    <section
      ...
      :style="
        ...
        Configguration.backgroundColorLeft +
        ', ' +
    ...
    >
      ...
      <h1 class="project-name">{{ Configguration.blogTitle }}</h1>
      <h2 class="project-tagline">{{ Configguration.blogDescribe }}</h2>
      <a
        :href="'https://github.com/' + Configguration.githubUsername"
        class="btn"
        target="_blank"
        >GitHub主页</a
      >
      <a
        href="https://github.com/lbiojian1234/VBlog"
        class="btn"
        target="_blank"
        v-if="!Configguration.mini"
        >博客源码</a
      >
    </section>
    <div
        ...
        <el-row>
          ...
          >
            ...
            <audio ref="music" loop autoplay v-if="Configguration.audioAutoPlay">
              <source :src="Configguration.audioUrl" type="audio/mpeg" />
            </audio>
          ...
          <el-col :span="4" style="text-align: right">
            <div style="font-size: 20px; color: #606266; margin-top: 5px">
              <b>{{ Configguration.githubUsername }}</b>
            </div>
            <div style="color: #606266">
              <i class="el-icon-location"></i>&nbsp;{{
                Configguration.location ? Configguration.location : "未填写地址"
              }}
              <br />
            </div>
          </el-col>
          <el-col :span="2" style="text-align: center">
            <img
              v-popover:bigAvatar
              :src="GRIDSOME_API_URL+Configguration.avatar.url"
              style="
                margin-top: 4px;
                margin-right: 10px;
                width: 52px;
            ...
            <el-popover
              ref="bigAvatar"
              placement="top-start"
              :title="Configguration.githubUsername"
              width="200"
              trigger="hover"
            >
              <i class="el-icon-star-on"></i>&emsp;{{ Configguration.name }}
              <br />
              <i class="el-icon-location"></i>&emsp;{{ Configguration.location }}
              <br />
              <img :src="GRIDSOME_API_URL+Configguration.avatar.url" style="width: 200px; height: 200px" />
            </el-popover>
          </el-col>
        </el-row>
      </el-card>
...
<static-query>
query {
  Configguration: allStrapiConfigguration {
    edges {
      node {
        githubUsername
        blogTitle
...
export default {
  ...
  computed: {
    Configguration() {
      return this.$static.Configguration.edges[0].node;
    },
  },
  data() {
    return {
